...
function M:notifications_on()
  -- enable notifications
    vim.notify = self.notify
end

function M:notifications_off()
  -- disable notifications
    vim.notify = function(s)end
end

function M:notifications_toggle()
  -- toggle notifications
  if self.notify_enabled then
    M:notifications_off()
  else
    M:notifications_on()
  end 
